...
_Generated: 2026-09-12T14:32:20.467Z_
...
Workspace `mcp.json` _(folder: python-oop1-lab)_

- **\\wsl.localhost\Ubuntu\home\beatrice\python-oop1-lab\.vscode\mcp.json** — _File missing_
